<script lang="ts">
	...
	let scrollDirection2: ScrollDirection;
	let scrollDirection3: ScrollDirection;
	let options: Options = {
		rootMargin: '-200px',
...
<section id="projects" class="projects_wrapper">
	<div>
		<h2
			class="numbered-heading {scrollDirection?.vertical === 'up'
				? 'fade-enter-done-botton'
				: 'fade-enter-proccess'}"
			style="animation-duration:0.5s; animation-delay:0ms"
		>
			Some Things I’ve Built
		</h2>
		<ul class="featured__projects">
			<li class="project" use:inview={options} on:change={handleChange}>
				{#if isInView}
					<div
						class="project-content z-10 {scrollDirection.vertical === 'up'
							? 'fade-enter-done-botton'
							: 'fade-enter-proccess'}"
						style="animation-duration: 0.5s; animation-delay:200ms"
					>
						<div>
							...
							<div class="project-description">
								<p>
									...
									Available on <a
										...
										target="_blank"
										rel="noopener noreferrer">Visual Studio Marketplace</a
									>,
									<a
										href="https://packagecontrol.io/packages/Halcyon%20Theme"
										target="_blank"
										rel="noopener noreferrer">Package Control</a
									>,
									<a
										href="https://atom.io/themes/halcyon-syntax"
										target="_blank"
										rel="noopener noreferrer">Atom Package Manager</a
									>, and
									<a
					...
					<div
						class="project-image {scrollDirection.vertical === 'up'
							? 'fade-enter-done-botton'
							: 'fade-enter-proccess'}"
			...
			<li class="project" use:inview={options} on:change={handleChange2}>
				{#if isInView2}
					<div
						class="project-content z-10 {scrollDirection2?.vertical === 'up'
							? 'fade-enter-done-botton'
							: 'fade-enter-proccess'}"
					...
					>
						<div>
							<p class="project-overline">Featured Project</p>
							<h3 class="project-title">
								<a href="https://spotify-profile.herokuapp.com/" target="_blank">Spotify Profile</a>
							</h3>
							<div class="project-description">
								<p>
							...
							<div class="project-links">
								<a href="https://github.com/bchiang7/spotify-profile" target="_blank"
									><svg
										xmlns="http://www.w3.org/2000/svg"
										role="img"
										viewBox="0 0 24 24"
					...
					<div
						class="project-image {scrollDirection2?.vertical === 'up'
							? 'fade-enter-done-botton'
							: 'fade-enter-proccess'}"
						style="animation-duration:0.5s;"
					>
			...
			<li class="project" use:inview={options} on:change={handleChange3}>
				{#if isInView3}
					<div
						class="project-content z-10 {scrollDirection.vertical === 'up'
							? 'fade-enter-done-botton'
						...
						<div>
							...
							<h3 class="project-title">
								<a
									...
									rel="noopener noreferrer"
									target="_blank">Build a Spotify Connected App</a
								>
							</h3>
							<div class="project-description">
								<p>
									Having struggled with understanding how the Spotify OAuth flow works, I made the
									course I wish I could have had.
								</p>
								<p>
									Unlike tutorials that only cover a few concepts and leave you with half-baked
									GitHub repositories, this course covers everything from explaining the principles
									of REST APIs to implementing Spotify's OAuth flow and fetching API data in a React
									app. By the end of the course, you’ll have an app deployed to the internet you can
					...
					<div
						...
						style="animation-duration:0.5s"
					>
						<a href="https://www.newline.co/courses/build-a-spotify-connected-app" target="_blank">
							<div class="gatsby-image-wrapper gatsby-image-wrapper-constrained img">
								...
								<picture>
									<img
										src="https://brittanychiang.com/static/4e06bd39766c182ea26b255309b1dee1/7ec1a/course-card.avif"
